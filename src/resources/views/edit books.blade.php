...
<div class="row content">
    ...
    <div class="main">
        ...
        <div class="main__wrap" id="primary">
            <h2 class="main__title">Редактировать книгу</h2>
            <div id="modalAdd">
                <form action="{{route('edit_books', ['id'=>$books->id])}}" method="post" id="book_form" class="main__add" enctype= multipart/form-data>
                    @csrf

                    <div class=" main__item">
                        <label class="main__clause">Имя </label>

                        <input id="name" name="name" type="text" value="{{$books['name']}}" class="main__input">
                    </div>
                    <div class=" main__item">
                        <label class="main__clause">Год </label>
                        <input id="year" name="year" type="text" value="{{$books['year']}}" class="main__input">
                    </div>
                    ...
                    <div class="row main__item main__location">
                        <button id="save_books_button" type="submit" class="main__save">Редактировать</button>
                    </div>
                </form>
                @if (count($errors) > 0)
                    <div>
